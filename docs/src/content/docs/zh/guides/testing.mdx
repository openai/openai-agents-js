...
| 测试 `RealtimeAgent` 函数工具 | 发出 `function_call` 并预期调用 `sendFunctionCallOutput` | [测试语音智能体工具工作流](#test-a-realtime-agent-tool-workflow) |
...
- [语音智能体概述](/openai-agents-js/zh/guides/voice-agents)介绍了 `RealtimeSession`。
