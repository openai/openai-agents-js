...
如果您想了解更多关于追踪功能的信息，请查看[追踪](/openai-agents-js/zh/guides/tracing)。
...
如需记录会话持久化活动，设置 `OPENAI_AGENTS__DEBUG_SAVE_SESSION=1`。

您可以通过 `@openai/agents` 中的 `getLogger(namespace)` 为自己的模块获取命名空间记录器。
