...
Agents SDK は標準で Responses API または Chat Completions API を通じて OpenAI モデルと動作します。別のモデルを使いたい場合は、[Vercel の AI SDK](https://sdk.vercel.ai/) が幅広い対応モデルを提供しており、このアダプターを通じて Agents SDK に取り込むことができます。
