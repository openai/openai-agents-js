...
canonicalHeadingIds:
  - depth: 2
    id: 'enabling-streaming'
    aliases:
      - 'ストリーミングの有効化'
  - depth: 3
    id: 'get-the-text-output'
    aliases:
      - 'テキスト出力の取得'
  - depth: 3
    id: 'listen-to-all-events'
    aliases:
      - '全イベントの監視'
  - depth: 3
    id: 'responses-websocket-transport-optional'
    aliases:
      - 'responses-websocket-トランスポート任意'
  - depth: 2
    id: 'event-types'
    aliases:
      - 'イベント型'
  - depth: 3
    id: 'raw_model_stream_event'
    aliases: []
  - depth: 3
    id: 'run_item_stream_event'
    aliases: []
  - depth: 3
    id: 'agent_updated_stream_event'
    aliases: []
  - depth: 2
    id: 'human-in-the-loop-while-streaming'
    aliases:
      - 'ストリーミング中の-human-in-the-loop-人間の介入'
  - depth: 2
    id: 'stop-a-stream-and-continue-the-same-turn'
    aliases:
      - 'ストリームの停止と同じターンの継続'
  - depth: 2
    id: 'tips'
