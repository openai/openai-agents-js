...
完全な設定については、[Cloudflare 上の音声エージェント](/openai-agents-js/ja/extensions/cloudflare)を参照してください。
...
完全な設定については、[Twilio 上の音声エージェント](/openai-agents-js/ja/extensions/twilio)を参照してください。
