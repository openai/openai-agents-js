...
Voice Agents は OpenAI の音声対音声モデルを使用して、リアルタイムな音声チャットを提供します。これらのモデルはストリーミング音声、テキスト、ツール呼び出しをサポートし、音声/電話のカスタマーサポート、モバイルアプリの体験、音声チャットなどに最適です。
...
<LinkCard
  ...
  description="OpenAI Agents SDK を使って、ほんの数分ではじめてのリアルタイム音声アシスタントを作成します。"
/>
...
音声対音声モデルを使用することで、モデルが動作した後にテキストへ書き起こして再度音声に変換し直す必要がなく、モデルのリアルタイムな音声処理能力を活用できます。
