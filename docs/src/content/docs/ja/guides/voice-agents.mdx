...
Voice Agents は OpenAI の speech-to-speech モデルを使って、リアルタイムの音声チャットを提供します。これらのモデルは音声、テキスト、ツール呼び出しのストリーミングに対応し、音声／電話でのカスタマーサポート、モバイルアプリでの体験、音声チャットなどに最適です。
...
<LinkCard
  ...
  description="OpenAI Agents SDK を使って、ほんの数分で最初のリアルタイム音声アシスタントを構築しましょう。"
/>
...
speech-to-speech モデルを使用することで、モデルが動作した後にテキストへ文字起こしして再び音声に変換し直すことなく、リアルタイムに音声を処理できます。
