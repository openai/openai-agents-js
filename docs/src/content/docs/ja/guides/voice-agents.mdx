...
音声エージェントは OpenAI の音声対音声モデルを使って、リアルタイムの音声チャットを実現します。これらのモデルは音声、テキスト、ツール呼び出しのストリーミングに対応し、音声/電話によるカスタマーサポート、モバイルアプリの体験、音声チャットなどの用途に最適です。
...
<LinkCard
  ...
  description="OpenAI Agents SDK を使って最初のリアルタイム音声アシスタントを数分で構築できます。"
/>
...
音声対音声モデルを使用することで、モデルが動作した後にテキストへ文字起こしして再度音声へ変換する必要がなく、モデルのリアルタイム音声処理能力を活用できます。
