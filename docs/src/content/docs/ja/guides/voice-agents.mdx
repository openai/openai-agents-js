...
音声エージェントは OpenAI の音声から音声へのモデルを使用して、リアルタイムの音声チャットを提供します。これらのモデルは音声、テキスト、ツール呼び出しのストリーミングをサポートし、音声/電話のカスタマーサポート、モバイルアプリ体験、音声チャットなどのアプリケーションに最適です。
...
<LinkCard
  ...
  description="OpenAI Agents SDK を使って、ほんの数分ではじめてのリアルタイム音声アシスタントを構築します。"
/>
...
音声から音声へのモデルを使うことで、モデルが動作した後にテキストを書き起こして音声へ再変換することなく、モデルのリアルタイム音声処理能力を活用できます。
