...
音声エージェントは OpenAI の speech-to-speech モデルを使用して、リアルタイムの音声チャットを提供します。これらのモデルは音声、テキスト、ツール呼び出しのストリーミングをサポートし、音声/電話でのカスタマーサポート、モバイルアプリ体験、音声チャットなどの用途に最適です。
...
speech-to-speech モデルを使用することで、音声をリアルタイムに処理するモデルの能力を活用でき、モデルの応答後にテキストへ文字起こししてから再度音声へ変換する必要がありません。
