...
音声エージェントは OpenAI の音声対音声モデルを使って、リアルタイムの音声チャットを提供します。これらのモデルは、音声・テキスト・ツール呼び出しのストリーミングに対応し、音声/電話のカスタマーサポート、モバイルアプリの体験、音声チャットなどの用途に最適です。
...
<LinkCard
  ...
  description="OpenAI Agents SDK を使って、数分で最初のリアルタイム音声アシスタントを構築しましょう。"
/>
...
音声対音声モデルを使用することで、モデルが音声をリアルタイムに処理する能力を活用でき、モデルの応答後に文字起こしやテキストを再び音声に変換する必要がありません。
