...
| --- | --- |
| Connect a browser client safely with WebRTC and ephemeral tokens | [Realtime Agents Quickstart](/openai-agents-js/guides/voice-agents/quickstart) |
| Understand session lifecycle, VAD, interruptions, image input, tools, and history | [Building Realtime Agents](/openai-agents-js/guides/voice-agents/build) |
