...
![Voice Agents](https://cdn.openai.com/API/docs/images/diagram-speech-to-speech.png)
...
| Run a phone or telephony experience on Twilio | [Voice Agents on Twilio](/openai-agents-js/extensions/twilio) |
| Connect from Cloudflare Workers or other workerd runtimes | [Voice Agents on Cloudflare](/openai-agents-js/extensions/cloudflare) |
