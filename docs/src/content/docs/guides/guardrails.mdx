...
> **Note** Output guardrails only run if the agent is the _last_ agent in the workflow. For realtime spoken interactions see [the Voice agents guide](/openai-agents-js/guides/voice-agents/build#guardrails).
