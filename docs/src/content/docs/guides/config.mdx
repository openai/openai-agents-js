...
This also redacts model-related error objects and details from SDK error logs, leaving only a safe error type.
...
This also redacts tool-related error objects and details from SDK error logs, including tool execution, approval formatting, and Realtime tool handling failures.
