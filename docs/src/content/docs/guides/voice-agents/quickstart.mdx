...
2. **Fire up the app and start talking**
   ...
   Start your web server and open the page that includes your new Voice Agent code. You should see a microphone permission request. Once you grant access, you should be able to start talking to your agent.
