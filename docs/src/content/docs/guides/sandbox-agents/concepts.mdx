...
`SandboxAgent` is still an `Agent`. It keeps the usual agent surface such as `instructions`, `tools`, `handoffs`, `mcpServers`, `modelSettings`, output types, guardrails, and hooks, and it still runs through the normal `run()` and `Runner` APIs. What changes is the execution boundary:
...
Throughout this page, "sandbox session" means the live execution environment managed by a sandbox client. It is different from the SDK's conversational `Session` interfaces described in [Sessions](/openai-agents-js/guides/sessions).
...
>
  ...
  <div>
    ...
    <span>Resume or fresh-start later</span>
  </div>
</div>
  ...
  <section>
    ...
    <ol>
      ...
      <li>
        ...
        <p>Runner creates or resumes a sandbox session.</p>
      </li>
      <li>
        <span aria-hidden="true">3</span>
        <p>Agent runs and snapshot-backed workspace state can persist.</p>
      </li>
      <li>
        <span aria-hidden="true">4</span>
        <p>Runner closes runner-owned resources.</p>
      </li>
    </ol>
  </section>
  <section>
    ...
    <ol>
      ...
      <li>
        <span aria-hidden="true">3</span>
        <p>Agent uses the existing workspace.</p>
      </li>
      <li>
        <span aria-hidden="true">4</span>
        <p>Inspect, reuse, then close the session yourself.</p>
      </li>
    </ol>
  </section>
</div>
