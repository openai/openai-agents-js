...
The core docs branch does not include the provider implementations yet. The provider branches should add exact environment variable notes, runnable examples, port behavior, PTY support, snapshot behavior, and cleanup behavior alongside the provider code.
