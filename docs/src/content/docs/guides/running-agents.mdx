...
- `errorHandlers.invalidFinalOutput` handles [`ModelBehaviorError`](/openai-agents-js/openai/agents-core/classes/modelbehaviorerror) instances raised when a structured final output is missing or fails output schema validation.
