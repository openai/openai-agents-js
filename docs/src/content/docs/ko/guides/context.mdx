...
컨텍스트는 여러 의미로 쓰입니다. 여기에는 두 가지 주요 범주가 있습니다:
...
<Aside type="note">
  컨텍스트 객체는 LLM에 **전송되지 않습니다**. 전적으로 로컬이므로 자유롭게 읽고
  쓸 수 있습니다.
</Aside>
...
4. 파일, 데이터베이스, 웹의 관련 데이터에 근거해 응답하도록 retrieval 또는 웹 검색 도구를 사용합니다
