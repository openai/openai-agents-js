...
<LinkCard
  ...
  description="OpenAI Agents SDK를 사용해 실시간 음성 어시스턴트를 몇 분 만에 구축하세요."
/>
...
- 도구 정의 및 호출
- 모델 출력 모니터링을 위한 맞춤형 가드레일
- 스트리밍된 이벤트에 대한 콜백
- 텍스트 에이전트와 음성 에이전트 모두에 동일한 구성 요소 재사용

음성-음성 모델을 사용하면, 모델이 동작한 후 텍스트를 다시 오디오로 변환하기 위해 전사/재변환할 필요 없이 모델의 실시간 오디오 처리 능력을 활용할 수 있습니다.
