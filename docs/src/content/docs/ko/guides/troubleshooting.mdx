...
- **Cloudflare Workers**: Agents SDK는 Cloudflare Workers에서 사용할 수 있으나, 현재 다음과 같은 제한이 있습니다:
...
- **v8 아이솔레이트**:
  - 적절한 브라우저 폴리필을 갖춘 번들러를 사용하면 v8 아이솔레이트용으로 SDK를 번들링할 수 있으나, 트레이싱은 동작하지 않습니다
...
또는 SDK의 특정 부분에 대해 범위를 좁혀 디버깅할 수 있습니다:
