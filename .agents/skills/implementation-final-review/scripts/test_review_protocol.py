...
class ReviewProtocolTest(unittest.TestCase):
        ...
        return {
            ...
            "review_state": {
                ...
                "revalidation_command": (
                    "PYTHONDONTWRITEBYTECODE=1 uv run python review_state.py --base BASE"
                ),
            },
            "verification": {
                "preflight_results": [
    ...
    def _receipt(self) -> dict[str, object]:
        ...
        return {
            "schema_version": 1,
            "command": (
                "PYTHONDONTWRITEBYTECODE=1 uv run python -m unittest discover -s scripts"
            ),
    ...
    def test_packet_defers_broad_final_gates_until_clean_review(self) -> None:
        ...
        packet["verification"]["eligible_concurrent_gates"] = "pnpm test"
        self._write_packet(self.packet_path, packet)
